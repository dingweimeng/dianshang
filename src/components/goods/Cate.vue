  ...
  <div>
    ...
    <el-card>
      ...
      <tree-table class="treeTable" :data="catelist" :columns="columns" :selection-type="false" :expand-type="false" show-index index-text="#" border>
        <!-- 是否有效 -->
        <template slot="isok" slot-scope="scopo">
          <i class="el-icon-success" v-if="scopo.row.cat_deleted === false" style="color: green"></i>
    ...
    <el-dialog title="添加分类" :visible.sync="addCateDialogVisible" width="50%" @close='addcateDialogClosed'>
      ...
      <el-form :model="addCateForm" :rules="addCateFormRules" ref="addCateFormRef" label-width="100px">
        ...
        <el-form-item label="父级分类">
          <!--options 用来指定数据源  -->
          <el-cascader expand-trigger="hover" :options="parentCateList" :props="cascaderProps" v-model="selectedKeys" @change="handleChange" clearable></el-cascader>
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    handleChange() {
      ...
      // 如果selectedKeys 数组中的length 大于0 证明选中分类
